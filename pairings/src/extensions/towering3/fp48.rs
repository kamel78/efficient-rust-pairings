...
impl <const PARAMSIZE:usize,const N:usize> Fp48Element <PARAMSIZE,N>{
    ...
    pub fn frobinus(&self, order :u8) -> Self {      
        match  order { 1 =>{ Self { content : [ self.content[0], 
                                                ...
                                                self.content[6].multiply(&self.constants.frobinus_consts[1]),
                                                self.content[7].negate().multiply(&self.constants.frobinus_consts[1]),
                                                ...
                                                self.content[11].substract(&self.content[10]).multiply(&self.constants.frobinus_consts[3]),
                                                self.content[9].substract(&self.content[8]).multiply(&self.constants.frobinus_consts[4]),
                                                self.content[9].addto(&self.content[8]).multiply(&self.constants.frobinus_consts[4]),                                              
                                                ...
                                                self.content[14].substract(&self.content[15]).multiply(&self.constants.frobinus_consts[6]),
                                                self.content[15].addto(&self.content[14]).negate().multiply(&self.constants.frobinus_consts[6]),                                                                                               
                                                ...
                                                self.content[18].negate().multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                                self.content[19].multiply(&self.constants.frobinus_consts[5].sub(1u64)),                                                
                                                self.content[22].substract(&self.content[23]).multiply(&self.constants.frobinus_consts[8]),
                                                self.content[23].addto(&self.content[22]).negate().multiply(&self.constants.frobinus_consts[8]),
                                                self.content[21].addto(&self.content[20]).multiply(&self.constants.frobinus_consts[9]),
                                                ...
                                                self.content[28].negate().multiply(&self.constants.frobinus_consts[11]),
                                                self.content[29].multiply(&self.constants.frobinus_consts[11]),                                                
                                                self.content[26].substract(&self.content[27]).multiply(&self.constants.frobinus_consts[12]),
                                                self.content[26].addto(&self.content[27]).negate().multiply(&self.constants.frobinus_consts[12]),
                                                self.content[25].addto(&self.content[24]).negate().multiply(&self.constants.frobinus_consts[13]),
                                                self.content[25].substract(&self.content[24]).multiply(&self.constants.frobinus_consts[13]),                                                
                                                self.content[36].multiply(&self.constants.frobinus_consts[14]),
                                                self.content[37].negate().multiply(&self.constants.frobinus_consts[14]),
                                                self.content[38].addto(&self.content[39]).multiply(&self.constants.frobinus_consts[15]),
                                                self.content[39].substract(&self.content[38]).negate().multiply(&self.constants.frobinus_consts[15]),                                                
                                                self.content[33].addto(&self.content[32]).multiply(&self.constants.frobinus_consts[16]),
                                                self.content[33].substract(&self.content[32]).negate().multiply(&self.constants.frobinus_consts[16]),                                                
                                                self.content[35].negate().multiply(&self.constants.frobinus_consts[17]),
                                                self.content[34].negate().multiply(&self.constants.frobinus_consts[17]),                                                
                                                self.content[47].addto(&self.content[46]).multiply(&self.constants.frobinus_consts[18]),
                                                self.content[47].substract(&self.content[46]).negate().multiply(&self.constants.frobinus_consts[18]),                                                                                                
                                                self.content[44].substract(&self.content[45]).negate().multiply(&self.constants.frobinus_consts[19]),
                                                self.content[44].addto(&self.content[45]).multiply(&self.constants.frobinus_consts[19]),                                                                                                                                                
                                                self.content[43].multiply(&self.constants.frobinus_consts[20]),
                                                self.content[42].multiply(&self.constants.frobinus_consts[20]),
                                                self.content[40].negate().multiply(&self.constants.frobinus_consts[21]),
                                                self.content[41].multiply(&self.constants.frobinus_consts[21])
                                                ],
                                    constants :self.constants }
                            },
                       2 =>{ Self { content : [ self.content[0], 
                                                ...
                                                self.content[9].multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                                self.content[8].negate().multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                                self.content[11].negate().multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                                self.content[10].multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                                self.content[12].multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                                self.content[13].multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                                self.content[14].negate().multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                                self.content[15].negate().multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                                ...
                                                self.content[20].multiply(&self.constants.frobinus_consts[5]),
                                                self.content[23].multiply(&self.constants.frobinus_consts[5]),
                                                self.content[22].negate().multiply(&self.constants.frobinus_consts[5]),
                                                self.content[25].substract(&self.content[24]).multiply(&self.constants.frobinus_consts[6]),
                                                self.content[25].addto(&self.content[24]).negate().multiply(&self.constants.frobinus_consts[6]),
                                                self.content[26].substract(&self.content[27]).multiply(&self.constants.frobinus_consts[6]),
                                                self.content[26].addto(&self.content[27]).multiply(&self.constants.frobinus_consts[6]),
                                                self.content[29].addto(&self.content[28]).multiply(&self.constants.frobinus_consts[6]),
                                                self.content[29].substract(&self.content[28]).multiply(&self.constants.frobinus_consts[6]),
                                                self.content[31].addto(&self.content[30]).negate().multiply(&self.constants.frobinus_consts[6]),
                                                self.content[30].substract(&self.content[31]).multiply(&self.constants.frobinus_consts[6]),
                                                self.content[33].addto(&self.content[32]).multiply(&self.constants.frobinus_consts[0]),
                                                self.content[33].substract(&self.content[32]).multiply(&self.constants.frobinus_consts[0]),
                                                self.content[34].addto(&self.content[35]).negate().multiply(&self.constants.frobinus_consts[0]),
                                                self.content[34].substract(&self.content[35]).multiply(&self.constants.frobinus_consts[0]),                                                
                                                self.content[36].substract(&self.content[37]).multiply(&self.constants.frobinus_consts[0]),                                                
                                                self.content[36].addto(&self.content[37]).multiply(&self.constants.frobinus_consts[0]),                                                
                                                self.content[39].substract(&self.content[38]).multiply(&self.constants.frobinus_consts[0]),                                                
                                                self.content[38].addto(&self.content[39]).negate().multiply(&self.constants.frobinus_consts[0]), 
                                                self.content[41].substract(&self.content[40]).multiply(&self.constants.frobinus_consts[7]),                                                
                                                self.content[41].addto(&self.content[40]).negate().multiply(&self.constants.frobinus_consts[7]),                                                
                                                self.content[42].substract(&self.content[43]).multiply(&self.constants.frobinus_consts[7]),                                                
                                                self.content[42].addto(&self.content[43]).multiply(&self.constants.frobinus_consts[7]),                                                
                                                self.content[44].addto(&self.content[45]).multiply(&self.constants.frobinus_consts[7]),                                                
                                                self.content[45].substract(&self.content[44]).multiply(&self.constants.frobinus_consts[7]),                                                
                                                self.content[46].addto(&self.content[47]).negate().multiply(&self.constants.frobinus_consts[7]),                                                
                                                self.content[46].substract(&self.content[47]).multiply(&self.constants.frobinus_consts[7]),                                                
                                                ],
                    constants :self.constants }
                            },      
                       4 =>{Self { content : [self.content[0], 
                                              ...
                                              self.content[16].multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                              self.content[17].multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                              self.content[18].multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                              self.content[19].multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                              self.content[20].negate().multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                              self.content[21].negate().multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                              self.content[22].negate().multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                              self.content[23].negate().multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                              self.content[25].multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                              self.content[24].negate().multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                              self.content[27].multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                              self.content[26].negate().multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                              self.content[29].negate().multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                              self.content[28].multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                              self.content[31].negate().multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                              self.content[30].multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                              ...
                                              self.content[41].negate().multiply(&self.constants.frobinus_consts[5]),
                                              self.content[40].multiply(&self.constants.frobinus_consts[5]),
                                              self.content[43].negate().multiply(&self.constants.frobinus_consts[5]),
                                              self.content[42].multiply(&self.constants.frobinus_consts[5]),
                                              self.content[45].multiply(&self.constants.frobinus_consts[5]),
                                              self.content[44].negate().multiply(&self.constants.frobinus_consts[5]),
                                              self.content[47].multiply(&self.constants.frobinus_consts[5]),
                                              self.content[46].negate().multiply(&self.constants.frobinus_consts[5]),
                                              ],
                                   constants :self.constants }},         
                       8 =>{Self { content : [self.content[0], 
                                              ...
                                              self.content[6],
                                              self.content[7],
                                              self.content[8].multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                              self.content[9].multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                              self.content[10].multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                              self.content[11].multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                              self.content[12].multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                              self.content[13].multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                              self.content[14].multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                              self.content[15].multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                              ...
                                              self.content[40].negate().multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                              self.content[41].negate().multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                              self.content[42].negate().multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                              self.content[43].negate().multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                              self.content[44].negate().multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                              self.content[45].negate().multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                              self.content[46].negate().multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                              self.content[47].negate().multiply(&self.constants.frobinus_consts[5].sub(1u64)),
                                            ],
                                  constants :self.constants }}
    ...
    pub fn invert(&self) -> Self {        
        let a = get_slice_fp24(&self, 0); 
        let b = get_slice_fp24(&self, 1); 
        let t = a.sqr().substract(&b.sqr().mulby_z().negate()).invert();
        let x0 = a.multiply(&t);
    ...
    pub fn unisqr(&self) -> Self { 
        // Adapted Scott's square for 2 - 3 - 2 - 2 construction from "Choosing and generating parameters for low level pairing implementation on BN curves" section 7.2.2
        ...
        let a2 = b42.mulby_w().addto(&b12).mulbyu8(3u8).negate().substract(&x1.addto(&x1));
        let a4 = b52.mulby_w().addto(&b22).mulbyu8(3u8).substract(&x2.addto(&x2));
        let a1 = b2pb5_2.substract(&b22).substract(&b52).mulbyu8(3u8).mulby_w().negate().addto(&x3.addto(&x3));
    ...
    pub fn final_exponentiation(&self, use_naf:bool) ->Self {      
        // It realy compute (f^(3*(p^48-1)/r)) (the power of a pairings is a pairings)
        ...
        if twist_type =='D' { //  D-type (with negation), sparse multiplication of an Fp24 element with a sparse element 
                                ...
                                let y: [&[FieldElement<N>]; 3] = [&[self.content[0].zero();8],
                                                                    ...
                                                                    &[  rhs[0][0].addto(&rhs[2][1].negate()),rhs[0][1].addto(&rhs[2][0]),
                                                                        rhs[0][2].addto(&rhs[2][3].negate()),rhs[0][3].addto(&rhs[2][2]),
