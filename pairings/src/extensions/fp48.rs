...
impl <const PARAMSIZE:usize,const N:usize> ExtElement<PARAMSIZE,48,N> for Fp48Element<PARAMSIZE,N>{
    ...
    fn content_interface(&self) -> &[super::super::fields::prime_fields::FieldElement<N>;48]
        {   &self.content   }
    ...
    fn sqr(&self) -> Self {
        ...
        let x0 = t1.mulby_u_p_1().addto(&t0);
...
impl <const PARAMSIZE:usize,const N:usize> Fp48Element <PARAMSIZE,N>{
    ...
    pub fn frobinus(&self, order :u8) -> Self {      
        match  order { 1 =>{ Self { content : [ self.content[0], 
                                                ...
                                                self.content[10].addto(&self.content[11]).multiply(&self.constants.frobinus_consts[3]),
                                                ...
                                                self.content[31].negate().multiply(&self.constants.frobinus_consts[10]),
                                                self.content[30].negate().multiply(&self.constants.frobinus_consts[10]),
                                                ...
                                                self.content[26].substract(&self.content[27]).negate().multiply(&self.constants.frobinus_consts[12]),
                                                self.content[26].addto(&self.content[27]).multiply(&self.constants.frobinus_consts[12]),
                                                ...
                                                self.content[36].negate().multiply(&self.constants.frobinus_consts[14]),
                                                self.content[37].multiply(&self.constants.frobinus_consts[14]),
                                                self.content[38].addto(&self.content[39]).negate().multiply(&self.constants.frobinus_consts[15]),
                                                self.content[39].substract(&self.content[38]).multiply(&self.constants.frobinus_consts[15]),
                                                self.content[33].addto(&self.content[32]).negate().multiply(&self.constants.frobinus_consts[16]),
                                                self.content[33].substract(&self.content[32]).multiply(&self.constants.frobinus_consts[16]),                                                
                                                self.content[35].multiply(&self.constants.frobinus_consts[17]),
                                                self.content[34].multiply(&self.constants.frobinus_consts[17]),
                                                self.content[47].addto(&self.content[46]).negate().multiply(&self.constants.frobinus_consts[18]),
                                                self.content[47].substract(&self.content[46]).multiply(&self.constants.frobinus_consts[18]),                                                                                                
                       ...
                       2 =>{ Self { content : [ self.content[0], 
                                                ...
                                                self.content[25].substract(&self.content[24]).negate().multiply(&self.constants.frobinus_consts[6]),
                                                self.content[25].addto(&self.content[24]).multiply(&self.constants.frobinus_consts[6]),
                                                self.content[26].substract(&self.content[27]).negate().multiply(&self.constants.frobinus_consts[6]),
                                                self.content[26].addto(&self.content[27]).negate().multiply(&self.constants.frobinus_consts[6]),
                                                self.content[29].addto(&self.content[28]).negate().multiply(&self.constants.frobinus_consts[6]),
                                                self.content[29].substract(&self.content[28]).negate().multiply(&self.constants.frobinus_consts[6]),
                                                self.content[31].addto(&self.content[30]).multiply(&self.constants.frobinus_consts[6]),
                                                self.content[31].substract(&self.content[30]).multiply(&self.constants.frobinus_consts[6]),
                    ...
                    constants :self.constants }
                       ...
                       4 =>{Self { content : [self.content[0], 
                                              ...
                                              self.content[25].negate().multiply(&self.constants.frobinus_consts[5].add(1u64)),
                                              self.content[24].multiply(&self.constants.frobinus_consts[5].add(1u64)),
                                              self.content[27].negate().multiply(&self.constants.frobinus_consts[5].add(1u64)),
                                              self.content[26].multiply(&self.constants.frobinus_consts[5].add(1u64)),
                                              self.content[29].multiply(&self.constants.frobinus_consts[5].add(1u64)),
                                              self.content[28].negate().multiply(&self.constants.frobinus_consts[5].add(1u64)),
                                              self.content[31].multiply(&self.constants.frobinus_consts[5].add(1u64)),
                                              self.content[30].negate().multiply(&self.constants.frobinus_consts[5].add(1u64)),
                                              ...
                                              self.content[41].multiply(&self.constants.frobinus_consts[5]),
                                              self.content[40].negate().multiply(&self.constants.frobinus_consts[5]),
                                              self.content[43].multiply(&self.constants.frobinus_consts[5]),
                                              self.content[42].negate().multiply(&self.constants.frobinus_consts[5]),
                                              self.content[45].negate().multiply(&self.constants.frobinus_consts[5]),
                                              self.content[44].multiply(&self.constants.frobinus_consts[5]),
                                              self.content[47].negate().multiply(&self.constants.frobinus_consts[5]),
                                              self.content[46].multiply(&self.constants.frobinus_consts[5]),
                                              ],
                                   constants :self.constants }}                                 
                       8 =>{Self { content : [self.content[0], 
                                              ...
                                              self.content[6],
                                              self.content[7],
                                              self.content[8].negate().multiply(&self.constants.frobinus_consts[5].add(1u64)),
                                              self.content[9].negate().multiply(&self.constants.frobinus_consts[5].add(1u64)),
                                              self.content[10].negate().multiply(&self.constants.frobinus_consts[5].add(1u64)),
                                              self.content[11].negate().multiply(&self.constants.frobinus_consts[5].add(1u64)),
                                              self.content[12].negate().multiply(&self.constants.frobinus_consts[5].add(1u64)),
                                              self.content[13].negate().multiply(&self.constants.frobinus_consts[5].add(1u64)),
                                              self.content[14].negate().multiply(&self.constants.frobinus_consts[5].add(1u64)),
                                              self.content[15].negate().multiply(&self.constants.frobinus_consts[5].add(1u64)),
                                              ...
                                              self.content[24].negate().multiply(&self.constants.frobinus_consts[5]),
                                              self.content[25].negate().multiply(&self.constants.frobinus_consts[5]),
                                              self.content[26].negate().multiply(&self.constants.frobinus_consts[5]),
                                              self.content[27].negate().multiply(&self.constants.frobinus_consts[5]),
                                              self.content[28].negate().multiply(&self.constants.frobinus_consts[5]),
                                              self.content[29].negate().multiply(&self.constants.frobinus_consts[5]),
                                              self.content[30].negate().multiply(&self.constants.frobinus_consts[5]),
                                              self.content[31].negate().multiply(&self.constants.frobinus_consts[5]),
                                              ...
                                              self.content[40].multiply(&self.constants.frobinus_consts[5].add(1u64)),
                                              self.content[41].multiply(&self.constants.frobinus_consts[5].add(1u64)),
                                              self.content[42].multiply(&self.constants.frobinus_consts[5].add(1u64)),
                                              self.content[43].multiply(&self.constants.frobinus_consts[5].add(1u64)),
                                              self.content[44].multiply(&self.constants.frobinus_consts[5].add(1u64)),
                                              self.content[45].multiply(&self.constants.frobinus_consts[5].add(1u64)),
                                              self.content[46].multiply(&self.constants.frobinus_consts[5].add(1u64)),
                                              self.content[47].multiply(&self.constants.frobinus_consts[5].add(1u64)),
                                            ],
                                  constants :self.constants }}
    ...
    pub fn invert(&self) -> Self {        
        let a = get_slice_fp24(&self, 0); 
        let b = get_slice_fp24(&self, 1); 
        let t = a.sqr().substract(&b.sqr().mulby_u_p_1()).invert();
        let x0 = a.multiply(&t);
    ...
    pub fn unisqr(&self) -> Self { 
        ...
        let a0 = b32.mulby_u_p_1().addto(&b02).mulbyu8(3u8).substract(&x0.addto(&x0));
        let a2 = b42.mulby_u_p_1().addto(&b12).mulbyu8(3u8).substract(&x1.addto(&x1));
        let a4 = b52.mulby_u_p_1().addto(&b22).mulbyu8(3u8).substract(&x2.addto(&x2));
        let a1 = b2pb5_2.substract(&b22).substract(&b52).mulbyu8(3u8).mulby_u_p_1().addto(&x3.addto(&x3));
    ...
    pub fn sparse_multiply(&self, rhs:&[&[FieldElement<N>];3]) -> Self {       
        ...
        let t0 = a0.sparse_multiply_for48(&rhs,1);        
        let t1 = b0.sparse_multiply_for48(&rhs,2);
        let t2 = t1.mulby_u_p_1();
        let y = [rhs[0],
                                          &[rhs[1][0].addto(&rhs[2][0]),rhs[1][1].addto(&rhs[2][1]),rhs[1][2].addto(&rhs[2][2]),rhs[1][3].addto(&rhs[2][3]),
                                          rhs[1][4].addto(&rhs[2][4]),rhs[1][5].addto(&rhs[2][5]),rhs[1][6].addto(&rhs[2][6]),rhs[1][7].addto(&rhs[2][7]) ],
                                          rhs[0]];
