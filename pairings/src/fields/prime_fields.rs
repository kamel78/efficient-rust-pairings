...
pub qprime:u128,
pub rsquare:[u64;N],
pub sqrtid:i16,                   // indicator for square root algo (-1 for p mod 4=3, leading zeros of s otherwise)   
...
pub tonelli_params :[[u64;N];2], // Parameters for sqrt tonelli-shanks algorithm  if p mod 4 = 1 :s,(s-1)/2,g
}
